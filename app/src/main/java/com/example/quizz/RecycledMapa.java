...
public class RecycledMapa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recycled_mapa);
        ...
        adapter.setOnItemClickListener(new Person_adapter.OnItemClickListener() {
            ...
            public void onItemClick(Nota persona) {
                Intent intent = new Intent (RecycledMapa.this, Resultado.class);
